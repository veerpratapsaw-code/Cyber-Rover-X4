  ...
  return (
    <section id="mobility" className="story-stage" style={{ background: 'linear-gradient(180deg, var(--bg-surface) 0%, var(--bg-base) 100%)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="chapter-number reveal-3d">03 // AUTONOMOUS MOBILITY & ULTRASONIC RANGING (MOVE)</div>
        ...
        <div style={{
          ...
          <div className="reveal-3d">
            <h2 className="section-headline" style={{ marginBottom: 'var(--space-4)' }}>
              Tri-Directional Ultrasonic (US) Acoustic Ranging
            </h2>
            <p style={{ color: 'var(--text-secondary)', marginBottom: 'var(--space-4)', fontSize: '1.0625rem', lineHeight: 1.7 }}>
              Unlike optical cameras that fail in dense smoke or darkness, CyberRover X4 utilizes three calibrated ultrasonic acoustic transducers spanning a 120-degree forward arc.
            </p>
            <p style={{ color: 'var(--text-muted)', marginBottom: 'var(--space-8)', fontSize: '0.9375rem', lineHeight: 1.6 }}>
              40kHz acoustic pulses reflect off barriers in real time. The ESP32 core processes echo return times at 50Hz, calculating vector clearances and feeding differential PWM signals to the 4WD motor array.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', borderLeft: '2px solid var(--status-nominal)', paddingLeft: '12px' }}>
                <div>
                  <div style={{ fontWeight: 600, color: 'var(--text-primary)', fontSize: '0.9375rem', fontFamily: 'var(--font-heading)' }}>
                    03 // Differential Traction Execution
                  </div>
                  <div style={{ fontSize: '0.8125rem', color: 'var(--text-secondary)', marginTop: '2px' }}>
                    L298N dual H-bridges modulate left/right motor PWM for zero-radius turns without stalling.
                  </div>
                </div>
              </div>
            </div>
